...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
	...
	float fSlow24 = dsp->fConst3 * (float)(dsp->fHslider8);
	float fSlow25 = dsp->fConst3 * (float)(dsp->fHslider9);
	/* C99 loop */
	{
		int i0;
		for (i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			dsp->fRec18[0] = fSlow9 + dsp->fConst4 * dsp->fRec18[1];
			...
			float fTemp34 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst5 / fTemp29));
			...
			float fTemp37 = fmaxf(0.0f, fminf(dsp->fConst6 * dsp->fRec19[0], 1.0f) - dsp->fConst7 * (float)(dsp->iRec20[0]));
			dsp->fVbargraph3 = (FAUSTFLOAT)(fTemp37);
			dsp->fRec22[0] = fSlow12 + dsp->fConst4 * dsp->fRec22[1];
			...
			float fTemp43 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst5 / fTemp38));
			...
			float fTemp46 = fmaxf(0.0f, fminf(dsp->fConst6 * dsp->fRec23[0], 1.0f) - dsp->fConst7 * (float)(dsp->iRec24[0]));
			dsp->fVbargraph4 = (FAUSTFLOAT)(fTemp46);
			dsp->fRec26[0] = fSlow15 + dsp->fConst4 * dsp->fRec26[1];
			...
			float fTemp52 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst5 / fTemp47));
			...
			float fTemp55 = fmaxf(0.0f, fminf(dsp->fConst6 * dsp->fRec27[0], 1.0f) - dsp->fConst7 * (float)(dsp->iRec28[0]));
			dsp->fVbargraph5 = (FAUSTFLOAT)(fTemp55);
			dsp->fRec30[0] = fSlow18 + dsp->fConst4 * dsp->fRec30[1];
			...
			float fTemp61 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst5 / fTemp56));
			...
			float fTemp64 = fmaxf(0.0f, fminf(dsp->fConst6 * dsp->fRec31[0], 1.0f) - dsp->fConst7 * (float)(dsp->iRec32[0]));
			dsp->fVbargraph6 = (FAUSTFLOAT)(fTemp64);
			dsp->fRec34[0] = fSlow21 + dsp->fConst4 * dsp->fRec34[1];
			...
			float fTemp70 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst5 / fTemp65));
			...
			float fTemp73 = fmaxf(0.0f, fminf(dsp->fConst6 * dsp->fRec35[0], 1.0f) - dsp->fConst7 * (float)(dsp->iRec36[0]));
			dsp->fVbargraph7 = (FAUSTFLOAT)(fTemp73);
			dsp->fRec37[0] = fSlow24 + dsp->fConst4 * dsp->fRec37[1];
			float fTemp74 = dsp->fConst8 * dsp->fRec37[0];
			float fTemp75 = 1.0f - fTemp74;
			dsp->fRec38[0] = fSlow25 + dsp->fConst4 * dsp->fRec38[1];
