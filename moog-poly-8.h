...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
	...
	/* C99 loop */
	{
		...
		for (i0 = 0; i0 < count; i0 = i0 + 1) {
			dsp->iVec0[0] = 1;
			dsp->fRec5[0] = fSlow0 + 0.1f * dsp->fRec5[1];
			float fTemp0 = fmaxf(dsp->fRec5[0], 23.44895f);
			...
			float fTemp6 = ((iTemp4) ? 0.0f : dsp->fRec6[1] + dsp->fConst3 * fTemp5);
			dsp->fRec6[0] = fTemp6 - floorf(fTemp6);
			float fTemp7 = mydsp_faustpower2_f(2.0f * dsp->fRec6[0] + -1.0f);
			dsp->fVec1[0] = fTemp7;
			...
			dsp->fRec9[0] = fSlow3 + dsp->fConst7 * dsp->fRec9[1];
			dsp->fRec10[0] = fSlow4 + dsp->fConst7 * dsp->fRec10[1];
			float fTemp11 = dsp->fConst8 * dsp->fRec10[0];
			float fTemp12 = 1.0f - fTemp11;
			dsp->fRec12[0] = fSlow5 + 0.1f * dsp->fRec12[1];
			float fTemp13 = fmaxf(dsp->fRec12[0], 23.44895f);
			float fTemp14 = fmaxf(2e+01f, fabsf(fTemp13));
			float fTemp15 = ((iTemp4) ? 0.0f : dsp->fRec11[1] + dsp->fConst3 * fTemp14);
			dsp->fRec11[0] = fTemp15 - floorf(fTemp15);
			float fTemp16 = mydsp_faustpower2_f(2.0f * dsp->fRec11[0] + -1.0f);
			dsp->fVec4[0] = fTemp16;
			float fTemp17 = fTemp3 * (fTemp16 - dsp->fVec4[1]) / fTemp14;
			dsp->fVec5[dsp->IOTA0 & 4095] = fTemp17;
			float fTemp18 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp13));
			...
			float fTemp21 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec13[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec14[0]));
			dsp->fVbargraph1 = (FAUSTFLOAT)(fTemp21);
			dsp->fRec16[0] = fSlow8 + 0.1f * dsp->fRec16[1];
			float fTemp22 = fmaxf(dsp->fRec16[0], 23.44895f);
			float fTemp23 = fmaxf(2e+01f, fabsf(fTemp22));
			float fTemp24 = ((iTemp4) ? 0.0f : dsp->fRec15[1] + dsp->fConst3 * fTemp23);
			dsp->fRec15[0] = fTemp24 - floorf(fTemp24);
			float fTemp25 = mydsp_faustpower2_f(2.0f * dsp->fRec15[0] + -1.0f);
			dsp->fVec7[0] = fTemp25;
			float fTemp26 = fTemp3 * (fTemp25 - dsp->fVec7[1]) / fTemp23;
			dsp->fVec8[dsp->IOTA0 & 4095] = fTemp26;
			float fTemp27 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp22));
			...
			float fTemp30 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec17[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec18[0]));
			dsp->fVbargraph2 = (FAUSTFLOAT)(fTemp30);
			dsp->fRec20[0] = fSlow11 + 0.1f * dsp->fRec20[1];
			float fTemp31 = fmaxf(dsp->fRec20[0], 23.44895f);
			float fTemp32 = fmaxf(2e+01f, fabsf(fTemp31));
			float fTemp33 = ((iTemp4) ? 0.0f : dsp->fRec19[1] + dsp->fConst3 * fTemp32);
			dsp->fRec19[0] = fTemp33 - floorf(fTemp33);
			float fTemp34 = mydsp_faustpower2_f(2.0f * dsp->fRec19[0] + -1.0f);
			dsp->fVec10[0] = fTemp34;
			float fTemp35 = fTemp3 * (fTemp34 - dsp->fVec10[1]) / fTemp32;
			dsp->fVec11[dsp->IOTA0 & 4095] = fTemp35;
			float fTemp36 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp31));
			...
			float fTemp39 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec21[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec22[0]));
			dsp->fVbargraph3 = (FAUSTFLOAT)(fTemp39);
			dsp->fRec24[0] = fSlow14 + 0.1f * dsp->fRec24[1];
			float fTemp40 = fmaxf(dsp->fRec24[0], 23.44895f);
			float fTemp41 = fmaxf(2e+01f, fabsf(fTemp40));
			float fTemp42 = ((iTemp4) ? 0.0f : dsp->fRec23[1] + dsp->fConst3 * fTemp41);
			dsp->fRec23[0] = fTemp42 - floorf(fTemp42);
			float fTemp43 = mydsp_faustpower2_f(2.0f * dsp->fRec23[0] + -1.0f);
			dsp->fVec13[0] = fTemp43;
			float fTemp44 = fTemp3 * (fTemp43 - dsp->fVec13[1]) / fTemp41;
			dsp->fVec14[dsp->IOTA0 & 4095] = fTemp44;
			float fTemp45 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp40));
			...
			float fTemp48 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec25[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec26[0]));
			dsp->fVbargraph4 = (FAUSTFLOAT)(fTemp48);
			dsp->fRec28[0] = fSlow17 + 0.1f * dsp->fRec28[1];
			float fTemp49 = fmaxf(dsp->fRec28[0], 23.44895f);
			float fTemp50 = fmaxf(2e+01f, fabsf(fTemp49));
			float fTemp51 = ((iTemp4) ? 0.0f : dsp->fRec27[1] + dsp->fConst3 * fTemp50);
			dsp->fRec27[0] = fTemp51 - floorf(fTemp51);
			float fTemp52 = mydsp_faustpower2_f(2.0f * dsp->fRec27[0] + -1.0f);
			dsp->fVec16[0] = fTemp52;
			float fTemp53 = fTemp3 * (fTemp52 - dsp->fVec16[1]) / fTemp50;
			dsp->fVec17[dsp->IOTA0 & 4095] = fTemp53;
			float fTemp54 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp49));
			...
			float fTemp57 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec29[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec30[0]));
			dsp->fVbargraph5 = (FAUSTFLOAT)(fTemp57);
			dsp->fRec32[0] = fSlow20 + 0.1f * dsp->fRec32[1];
			float fTemp58 = fmaxf(dsp->fRec32[0], 23.44895f);
			float fTemp59 = fmaxf(2e+01f, fabsf(fTemp58));
			float fTemp60 = ((iTemp4) ? 0.0f : dsp->fRec31[1] + dsp->fConst3 * fTemp59);
			dsp->fRec31[0] = fTemp60 - floorf(fTemp60);
			float fTemp61 = mydsp_faustpower2_f(2.0f * dsp->fRec31[0] + -1.0f);
			dsp->fVec19[0] = fTemp61;
			float fTemp62 = fTemp3 * (fTemp61 - dsp->fVec19[1]) / fTemp59;
			dsp->fVec20[dsp->IOTA0 & 4095] = fTemp62;
			float fTemp63 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp58));
			...
			float fTemp66 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec33[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec34[0]));
			dsp->fVbargraph6 = (FAUSTFLOAT)(fTemp66);
			dsp->fRec36[0] = fSlow23 + 0.1f * dsp->fRec36[1];
			float fTemp67 = fmaxf(dsp->fRec36[0], 23.44895f);
			float fTemp68 = fmaxf(2e+01f, fabsf(fTemp67));
			float fTemp69 = ((iTemp4) ? 0.0f : dsp->fRec35[1] + dsp->fConst3 * fTemp68);
			dsp->fRec35[0] = fTemp69 - floorf(fTemp69);
			float fTemp70 = mydsp_faustpower2_f(2.0f * dsp->fRec35[0] + -1.0f);
			dsp->fVec22[0] = fTemp70;
			float fTemp71 = fTemp3 * (fTemp70 - dsp->fVec22[1]) / fTemp68;
			dsp->fVec23[dsp->IOTA0 & 4095] = fTemp71;
			float fTemp72 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst2 / fTemp67));
			...
			float fTemp75 = fmaxf(0.0f, fminf(dsp->fConst4 * dsp->fRec37[0], 1.0f) - dsp->fConst5 * (float)(dsp->iRec38[0]));
			dsp->fVbargraph7 = (FAUSTFLOAT)(fTemp75);
			dsp->fRec4[0] = (0.0f - dsp->fConst1 * ((fTemp1 - fTemp2) * dsp->fVec2[(dsp->IOTA0 - (iTemp9 + 1)) & 4095] - (fTemp8 - dsp->fVec2[(dsp->IOTA0 - iTemp9) & 4095] * (fTemp2 + (1.0f - fTemp1))))) * fTemp10 + dsp->fRec0[1] * (0.0f - 4.0f * fmaxf(0.0f, fminf(dsp->fRec9[0], 0.999999f))) + fTemp12 * dsp->fRec4[1] + dsp->fConst1 * ((fTemp17 - dsp->fVec5[(dsp->IOTA0 - iTemp19) & 4095] * (fTemp20 + (1.0f - fTemp18)) - (fTemp18 - fTemp20) * dsp->fVec5[(dsp->IOTA0 - (iTemp19 + 1)) & 4095]) * fTemp21 + (fTemp26 - dsp->fVec8[(dsp->IOTA0 - iTemp28) & 4095] * (fTemp29 + (1.0f - fTemp27)) - (fTemp27 - fTemp29) * dsp->fVec8[(dsp->IOTA0 - (iTemp28 + 1)) & 4095]) * fTemp30 + (fTemp35 - dsp->fVec11[(dsp->IOTA0 - iTemp37) & 4095] * (fTemp38 + (1.0f - fTemp36)) - (fTemp36 - fTemp38) * dsp->fVec11[(dsp->IOTA0 - (iTemp37 + 1)) & 4095]) * fTemp39 + (fTemp44 - dsp->fVec14[(dsp->IOTA0 - iTemp46) & 4095] * (fTemp47 + (1.0f - fTemp45)) - (fTemp45 - fTemp47) * dsp->fVec14[(dsp->IOTA0 - (iTemp46 + 1)) & 4095]) * fTemp48 + (fTemp53 - dsp->fVec17[(dsp->IOTA0 - iTemp55) & 4095] * (fTemp56 + (1.0f - fTemp54)) - (fTemp54 - fTemp56) * dsp->fVec17[(dsp->IOTA0 - (iTemp55 + 1)) & 4095]) * fTemp57 + (fTemp62 - dsp->fVec20[(dsp->IOTA0 - iTemp64) & 4095] * (fTemp65 + (1.0f - fTemp63)) - (fTemp63 - fTemp65) * dsp->fVec20[(dsp->IOTA0 - (iTemp64 + 1)) & 4095]) * fTemp66 + (fTemp71 - dsp->fVec23[(dsp->IOTA0 - iTemp73) & 4095] * (fTemp74 + (1.0f - fTemp72)) - (fTemp72 - fTemp74) * dsp->fVec23[(dsp->IOTA0 - (iTemp73 + 1)) & 4095]) * fTemp75);
			dsp->fRec3[0] = dsp->fRec4[0] + fTemp12 * dsp->fRec3[1];
			dsp->fRec2[0] = dsp->fRec3[0] + fTemp12 * dsp->fRec2[1];
			dsp->fRec1[0] = dsp->fRec2[0] + dsp->fRec1[1] * fTemp12;
			dsp->fRec0[0] = dsp->fRec1[0] * mydsp_faustpower4_f(fTemp11);
