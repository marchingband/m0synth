...
void instanceResetUserInterfacemydsp(mydsp* dsp) {
	...
	dsp->fHslider3 = (FAUSTFLOAT)(1e+02f);
...
void instanceConstantsmydsp(mydsp* dsp, int sample_rate) {
	...
	dsp->fConst3 = 44.1f / dsp->fConst0;
	dsp->fConst4 = 1.0f - dsp->fConst3;
	dsp->fConst5 = 0.5f * dsp->fConst0;
	dsp->fConst6 = 6.2831855f / dsp->fConst0;
}
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider8, "midi", "16");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "1-det", &dsp->fHslider8, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)-5e+01f, (FAUSTFLOAT)5e+01f, (FAUSTFLOAT)0.0001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider9, "midi", "14");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "1-oct", &dsp->fHslider9, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)2.0f, (FAUSTFLOAT)1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider12, "midi", "13");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "1-shape", &dsp->fHslider12, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider11, "midi", "15");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "1-vol", &dsp->fHslider11, (FAUSTFLOAT)0.5f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider7, "midi", "18");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "bell-vol", &dsp->fHslider7, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fButton0, "gate", "");
	ui_interface->addButton(ui_interface->uiInterface, "gate", &dsp->fButton0);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider4, "midi", "8");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "lfo -> pitch", &dsp->fHslider4, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.001f);
	...
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider6, "midi", "6");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "lfo freq", &dsp->fHslider6, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.01f, (FAUSTFLOAT)2e+01f, (FAUSTFLOAT)0.001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider5, "midi", "7");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "lfo wav", &dsp->fHslider5, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)2.0f, (FAUSTFLOAT)1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider10, "midi", "17");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "n-vol", &dsp->fHslider10, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)1.0f, (FAUSTFLOAT)0.001f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider3, "pitch", "");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "pitch", &dsp->fHslider3, (FAUSTFLOAT)1e+02f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)127.0f, (FAUSTFLOAT)1.0f);
	ui_interface->declare(ui_interface->uiInterface, &dsp->fHslider21, "midi", "21");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "vca-sel", &dsp->fHslider21, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)0.0f, (FAUSTFLOAT)2.0f, (FAUSTFLOAT)1.0f);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
	...
	int iSlow3 = iSlow2 >= 2;
	int iSlow4 = iSlow2 >= 1;
	float fSlow5 = powf(2.0f, 0.083333336f * ((float)(dsp->fHslider3) + -69.0f));
	float fSlow6 = 1.1e+02f * fSlow5;
	...
	float fSlow12 = 2.2e+02f * fSlow5;
	float fSlow13 = 4.4e+02f * fSlow5;
	float fSlow14 = (float)(dsp->fHslider7);
	float fSlow15 = powf(2.0f, 0.00083333335f * (float)(dsp->fHslider8));
	int iSlow16 = (int)((float)(dsp->fHslider9));
	int iSlow17 = iSlow16 >= 2;
	int iSlow18 = iSlow16 >= 1;
	float fSlow19 = 8.8e+02f * fSlow5;
	float fSlow20 = 4.656613e-10f * (float)(dsp->fHslider10);
	...
	/* C99 loop */
	{
		...
		for (i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp7 = fSlow7 * fTemp6 + 1.0f;
			float fTemp8 = fSlow12 * fTemp7;
			float fTemp9 = fSlow13 * fTemp7;
			dsp->fRec6[0] = dsp->fConst3 * fmaxf(2e+01f, fminf(((iSlow3) ? fTemp9 : ((iSlow4) ? fTemp8 : fSlow6 * fTemp7)), 1e+04f)) + dsp->fConst4 * dsp->fRec6[1];
			float fTemp10 = fmaxf(dsp->fRec6[0], 23.44895f);
			...
			float fTemp15 = fmaxf(0.0f, fminf(2047.0f, dsp->fConst5 / fTemp10));
			...
			float fTemp19 = fmaxf(2e+01f, fabsf(dsp->fRec6[0]));
			...
			dsp->fVec4[0] = fTemp21;
			dsp->fRec12[0] = dsp->fConst3 * fmaxf(2e+01f, fminf(fSlow15 * ((iSlow17) ? fSlow19 * fTemp7 : ((iSlow18) ? fTemp9 : fTemp8)), 1e+04f)) + dsp->fConst4 * dsp->fRec12[1];
			float fTemp22 = fmaxf(dsp->fRec12[0], 23.44895f);
			float fTemp23 = fmaxf(2e+01f, fabsf(fTemp22));
			float fTemp24 = ((iTemp1) ? 0.0f : dsp->fRec11[1] + dsp->fConst2 * fTemp23);
			dsp->fRec11[0] = fTemp24 - floorf(fTemp24);
			float fTemp25 = mydsp_faustpower2_f(2.0f * dsp->fRec11[0] + -1.0f);
			dsp->fVec5[0] = fTemp25;
			...
			float fTemp30 = dsp->fConst1 * (fTemp26 - dsp->fVec6[(dsp->IOTA0 - iTemp28) & 4095] * (fTemp29 + (1.0f - fTemp27)) - (fTemp27 - fTemp29) * dsp->fVec6[(dsp->IOTA0 - (iTemp28 + 1)) & 4095]);
			float fTemp31 = fmaxf(2e+01f, fabsf(dsp->fRec12[0]));
			float fTemp32 = ((iTemp1) ? 0.0f : dsp->fRec13[1] + dsp->fConst2 * fTemp31);
			dsp->fRec13[0] = fTemp32 - floorf(fTemp32);
			float fTemp33 = mydsp_faustpower2_f(2.0f * dsp->fRec13[0] + -1.0f);
			dsp->fVec7[0] = fTemp33;
			float fTemp34 = ((iSlow27) ? fTemp3 : fSlow28);
			dsp->fVec8[0] = fTemp34;
			int iTemp35 = fTemp34 > 0.0f;
			float fTemp36 = 0.1447178f * ((iTemp35) ? fSlow30 : fSlow29);
			int iTemp37 = fabsf(fTemp36) < 1.1920929e-07f;
			float fTemp38 = ((iTemp37) ? 0.0f : expf(0.0f - dsp->fConst2 / ((iTemp37) ? 1.0f : fTemp36)));
			dsp->fRec15[0] = (1.0f - fTemp38) * ((iTemp35) ? (float)(iTemp35) : 0.0f) + fTemp38 * dsp->fRec15[1];
			dsp->iRec16[0] = (dsp->iRec16[1] + (dsp->iRec16[1] > 0)) * (fTemp34 <= dsp->fVec8[1]) + (fTemp34 > dsp->fVec8[1]);
			float fTemp39 = (float)(dsp->iRec16[0]);
			float fTemp40 = ((iSlow26) ? fmaxf(0.0f, fminf(fSlow32 * fTemp39, fSlow33 * (fSlow31 - fTemp39) + 1.0f)) : dsp->fRec15[0]);
			dsp->fRec14[0] = dsp->fConst3 * fminf(fmaxf(2e+01f, fSlow23 * (fSlow24 * fTemp6 + 1.0f) * (fSlow25 * fTemp40 + 1.0f)), 2e+03f) + dsp->fConst4 * dsp->fRec14[1];
			float fTemp41 = dsp->fConst6 * (dsp->fRec14[0] + fTemp9);
			float fTemp42 = 1.0f - fTemp41;
			dsp->fRec4[0] = fSlow0 * ((iSlow1) ? dsp->fConst1 * (fTemp0 * (fTemp21 - dsp->fVec4[1]) / fTemp19) : fTemp18) + fSlow14 * (float)((int)(fTemp18) ^ (int)(fTemp30)) + fSlow20 * fTemp5 + fSlow21 * ((iSlow22) ? dsp->fConst1 * (fTemp0 * (fTemp33 - dsp->fVec7[1]) / fTemp31) : fTemp30) + fTemp42 * dsp->fRec4[1] + fSlow34 * dsp->fRec0[1];
			dsp->fRec3[0] = dsp->fRec4[0] + fTemp42 * dsp->fRec3[1];
			dsp->fRec2[0] = dsp->fRec3[0] + fTemp42 * dsp->fRec2[1];
			dsp->fRec1[0] = dsp->fRec2[0] + dsp->fRec1[1] * fTemp42;
			dsp->fRec0[0] = dsp->fRec1[0] * mydsp_faustpower4_f(fTemp41);
			output0[i0] = (FAUSTFLOAT)(dsp->fRec0[0] * ((iSlow36) ? fSlow28 : ((iSlow37) ? fTemp40 : 1.0f)));
