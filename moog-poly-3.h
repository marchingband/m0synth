...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
	...
	/* C99 loop */
	{
		...
		for (i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			dsp->fRec4[0] = dsp->fRec0[1] * (0.0f - 4.0f * fmaxf(0.0f, fminf(dsp->fRec5[0], 0.999999f))) + fTemp1 * dsp->fRec4[1] + (0.0f - dsp->fConst4 * (dsp->fVec2[(dsp->IOTA0 - iTemp10) & 4095] * (fTemp11 + (1.0f - fTemp9)) - fTemp8 + (fTemp9 - fTemp11) * dsp->fVec2[(dsp->IOTA0 - (iTemp10 + 1)) & 4095])) * fTemp12 + dsp->fConst4 * ((fTemp17 - dsp->fVec5[(dsp->IOTA0 - iTemp19) & 4095] * (fTemp20 + (1.0f - fTemp18)) - (fTemp18 - fTemp20) * dsp->fVec5[(dsp->IOTA0 - (iTemp19 + 1)) & 4095]) * fTemp21 + (fTemp26 - dsp->fVec8[(dsp->IOTA0 - iTemp28) & 4095] * (fTemp29 + (1.0f - fTemp27)) - (fTemp27 - fTemp29) * dsp->fVec8[(dsp->IOTA0 - (iTemp28 + 1)) & 4095]) * fTemp30);
